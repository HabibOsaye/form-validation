...
username.addEventListener(`input`, function () {
	...
	if (hasNumbspace(value)) {
		setError(username, `error-numbspace-username`, `You can't include spaces.`);
		return;
	} else {
		removeError(username, `error-numbspace-username`);
	}
...
password.addEventListener(`input`, function () {
	...
	/* Has space */
	if (hasNumbspace(value)) {
		setError(password, `error-numbspace-password`, `You can't include spaces.`);
		return;
	} else {
